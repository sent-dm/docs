Subscribers
Subscribers are how you organize and manage your brand or organization’s contacts / message recipients on Sent.dm. When you add a subscriber to your site’s contact list, Sent automatically detects and stores the different messaging channels available to reach that contact and also determines the contact’s primary messaging channel. Subscribers can be created, retrieved, updated, and deleted via Sent’s API. You can also view your subscribers and their individual details within the Sent.dm web app dashboard.
